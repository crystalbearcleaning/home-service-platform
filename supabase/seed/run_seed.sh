...
PHASE_6_SQL="${SCRIPT_DIR}/phase_6_seed.sql"
...
for f in "$PHASE_1_SQL" "$PHASE_3_SQL" "$PHASE_5_SQL" "$PHASE_6_SQL"; do
  if [ ! -f "$f" ]; then
...
apply_seed "Phase 6 seed" "$PHASE_6_SQL" "__SEED_ADMIN_EMAIL__" "$ESCAPED_EMAIL"
